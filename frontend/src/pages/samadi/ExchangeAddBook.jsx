  ...
  return (
    <div>
      ...
      <div style={styles.container}>
        <h1 style={styles.heading}>📚 Book Management for Managers </h1>
        <p style={styles.subtitle}>Managers can add books to the exchange store.</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.buttonContainer}>
            <button type="submit" style={styles.submitButton}> Add Book to Store</button>
          </div>
        </form>
      </div>
      <Footer />
